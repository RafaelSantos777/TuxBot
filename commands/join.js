...
export default {
	...
	*/
	async execute(interaction) { // TODO Permission to join ${voiceChannel} (check if it's formatted correctly when user provides no channel to join the in command and is in hidden channel that bot has no access to)
